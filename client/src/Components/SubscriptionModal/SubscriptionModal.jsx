...
"See approximately twice as many crafts between ads in your for you and following timelines.",
"Add bold and italic text in your crafts",
"Post longer videos and 1080p video upload.",
"All the existing Blue features, including edit craft, bookmark folders and early access to new features"
        ...
        <Box sx={style}>
          ...
          <div className="flex justify-center py-10">
            <div className=" w-[100%] space-y-10">
              <div className="p-5 rounded-md flex items-center justify-between bg-slate-800 shadow-lg">
                <h1 className="text-xs font-normal pr-5">
                  Blue subscription with a verified phone number will get a blue
                  checkmark once approved.
                </h1>
                <img
                  className="w-24 h-24"
                  src="https://th.bing.com/th?id=OIF.ua1w%2fiMYKz5rUAiCjHuyCA&pid=ImgDet&w=139&h=139&c=7&dpr=1.3"
                  alt=""
                />
              </div>
